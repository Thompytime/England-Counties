...
const countyImages = ['Bedfordshire.svg', 'Berkshire.svg', 'Bristol.svg', 'Buckinghamshire.svg',
    ...
    'Kent.svg', 'Lancashire.svg', 'Leicestershire.svg', 'Lincolnshire.svg',
    'Merseyside.svg', 'Norfolk.svg', 'North Yorkshire.svg', 'Northamptonshire.svg',
    'Northumberland.svg', 'Nottinghamshire.svg', 'Oxfordshire.svg', 'Rutland.svg',
    'Shropshire.svg', 'Somerset.svg', 'South Yorkshire.svg', 'Staffordshire.svg',
    'Suffolk.svg', 'Surrey.svg', 'Tyne and Wear.svg', 'Warwickshire.svg',
    'West Midlands.svg', 'West Sussex.svg', 'West Yorkshire.svg', 'Wiltshire.svg',
    'Worcestershire.svg'];
...
let gameOver = false;
const maxDistanceKm = 574; // Adjust as needed for England (was 120 for NI)
...
document.getElementById('submit-guess').addEventListener('click', function () {
    ...
    if (userGuess.toLowerCase() === correctAnswer.toLowerCase()) {
        ...
        if (attemptsLeft === 0) {
            document.getElementById('feedback').innerHTML = `Incorrect! The correct county is <span style="color: red;">${correctAnswer}</span>. You are in a Right State!`;
            document.getElementById('feedback').style.color = 'red';
